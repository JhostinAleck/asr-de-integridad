...
SECRET_KEY = 'django-insecure-z#iw(ei65sh93jq1ysc3_vrz@+)%u*4z^sr99s)#mu9govx1rm'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'unique-blocker',
    }
}

# Configuración de tiempo para bloqueo de IP (en segundos)
